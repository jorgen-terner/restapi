 ...
 * 
 * RestService är implementation-agnostisk och fungerar med valfri JAX-RS-provider
 * utan att koda ihop med någon specifik implementation.
 * 
 * Konfiguration sker genom RestServiceBuilder, t.ex.:
 * 
 * <b>Med timeouts:</b>
 * <pre>
...
public class RestService implements AutoCloseable
{
   private static final class ObjectMapperContextResolver implements ContextResolver<ObjectMapper>
   {
      ...
      private ObjectMapperContextResolver(ObjectMapper configuredMapper)
      {
   ...
   RestService(Client client, ErrorHandler errorHandler)
   {
      ...
      this.client.register(new ObjectMapperContextResolver(this.mapper));
